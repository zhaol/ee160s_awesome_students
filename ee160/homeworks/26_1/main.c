...
int main() {
  ...
  char print_account_summaries_and_balances_flag = 0;
  ...
  while (exit_program_flag == CONTINUE_PROGRAM) {
    ...
    print_account_summaries_and_balances_flag = ask_to_output_account_summaries_and_list_of_balances();
  if (print_account_summaries_and_balances_flag == OUTPUT_ACCOUNT_AND_BALANCES) {
  ...
  } else if (print_account_summaries_and_balances_flag == DO_NOT_OUTPUT_ACCOUNT_AND_BALANCES) {
    printf("\n");
    printf("Thank you for your time, friend.\n");
    }
