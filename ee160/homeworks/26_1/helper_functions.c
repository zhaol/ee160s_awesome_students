...
int ask_to_output_account_summaries_and_list_of_balances() {
  char print_account_summaries_and_balances_flag;
  printf("Would you like to know your account summary and balances?\n");
  printf("Yes = 'y' , No = 'n'\n");
  scanf(" %c", &print_account_summaries_and_balances_flag);
  return(print_account_summaries_and_balances_flag);
}